document.addEventListener('DOMContentLoaded', () => {
  fetch('api.php')
      ...
      data.forEach((ex, index) => {
        ...
        grid.innerHTML += `
          <div class="exhibition-card">
            <div class="img-placeholder" style="background: linear-gradient(rgba(0,0,0,0.1), rgba(0,0,0,0.5)), url('${imgSource}') center/cover;">
    ...
    .catch(error => {
      document.getElementById('exhibition-grid').innerHTML = '<p style="text-align:center; padding: 50px;">Nelze načíst data výstav.</p>';
    });
